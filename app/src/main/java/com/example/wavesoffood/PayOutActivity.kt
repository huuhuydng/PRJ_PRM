...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Initialize Firebase and Usser details
...
//        binding.totalAmount.isEnabled = false
        ...
        binding.placeMyOder.setOnClickListener {

            //getdataa from textview
    ...
    private fun placeOrder() {
        ...
        Log.d("CHECK_LIST_SIZE", "Names: ${foodItemName.size}, Prices: ${foodItemPrice.size}, Images: ${foodItemImage.size}, Quantities: ${foodItemQuantities.size}")
